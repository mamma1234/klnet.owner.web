...
// const pg = require('pg');
// const connUrl1 = `postgresql://${config.user}:${config.password}@${config.host}:${config.port}/${config.database}`
// var client = new pg.Client(connUrl1);
// client.connect();
...
// app.get("/api/customers1", (request, response) => {
