const OAuth2CognitoStrategy = require('passport-cognito-oauth2').Strategy;
...
module.exports = (passport) => {
    ...
    passport.use(new OAuth2CognitoStrategy({
        ...
        callbackURL: '/auth/cognito/callback',
        region: 'us-west-2',
        passReqToCallback: true
    }, async (req, accessToken, refreshToken, profile, done) => {
        try {
            console.log('(cognitoStrategy.js) profile:', profile, 'accessToken:', accessToken, 'refreshToken:', refreshToken);
